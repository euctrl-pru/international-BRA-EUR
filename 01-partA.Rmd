...
UpperLimit <- min(c(max(reg_bra$DATE), max(reg_eur$DATE)))
...
p1 <- reg_bra %>% mutate(DATE = as.Date(DATE)) %>%
  ...
  scale_x_date(date_breaks = "1 year", limits = c(as.Date("2019-01-01"), as.Date("2021-02-28")), date_labels = "%b-%Y", date_minor_breaks = "1 month") +
  theme_minimal() +
...
reg_tfc %>%
  ...
  scale_x_date(date_breaks = "1 year", limits = c(as.Date("2019-01-01"), as.Date("2021-02-28")), date_labels = "%b-%Y") +
  theme_minimal() +
